	...
	return (
		<div>
			...
			<ApiExample
				...
				snippet={(...args: [string, ContextHandler]) =>
					`fdc3.addIntentListener(${args},(context)=>{//do something with the context})`
				}
				inputs={[{ label: "addIntentListener:", placeholder: "ViewChart", inputValue: "" }]}
			/>
		</div>
	);
}
